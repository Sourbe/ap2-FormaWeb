...
function getUtilisateurByLogin($login) {
    ...
    try {
        $cnx = connexionPDO();
        $req = $cnx->prepare("select LOGINS, MDPS, NOMS, PRENOMS, ADRESSES, CPS, VILLES, EMAILS, STATUTS, FONCTIONS, NOMAS from stagiaire, association where LOGINS=:login and association.IDAS = stagiaire.IDAS");
